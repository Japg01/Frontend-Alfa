...
import 'package:alfa_soyzen/presentation/login/CreateNewPass.dart';
  ...
  return Column(
    ...
    children: [
      ...
      const Text(
        ...
        style: TextStyle(
          color: Colors.grey,
          fontSize: 14, // Tamaño de fuente más pequeño para el texto explicativo
        ),
      ),
      const SizedBox(height: 40), // Aumenta la distancia entre los textos
      _buildInputField(emailController, labelText: "Email"), // Agrega un texto al campo de correo electrónico
...
Widget _buildInputField(TextEditingController controller, {isPassword = false, String? labelText}) {
  return TextField(
    controller: controller,
    decoration: InputDecoration(
      labelText: labelText, // Utiliza el labelText proporcionado
      suffixIcon: isPassword ? const Icon(Icons.remove_red_eye) : const Icon(Icons.email),
    ),
